...
export APP__INFRA__STORAGE__CNN_URL="$REPO_ROOT/indexer.sqlite"
export APP__INFRA__LEDGER_DB__CNN_URL="$REPO_ROOT/ledger-db.sqlite"
export APP__INFRA__NODE__URL="wss://rpc.preprod.midnight.network"
export APP__INFRA__SPO_NODE__URL="wss://rpc.preprod.midnight.network"
